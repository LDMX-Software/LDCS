...
ecalVeto.parameters["bdt_file"] = "/usr/local/data/Configuration/gabrielle.pkl"
ecalVeto.parameters["disc_cut"] = 0.99
ecalVeto.parameters["cellxy_file"] = "/usr/local/data/Configuration/cellxy.txt"
...
p.sequence=[ecalDigis, ecalVeto, simpleTrigger, trackerHitKiller, findable_track, hcalDigis, hcalVeto ]
