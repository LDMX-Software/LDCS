...
#mySim.randomSeeds = [ 3, 4 ]

p.run = 2

# get the path to the installed
# detector description
from LDMX.Detectors.makePath import makeDetectorPath
mySim.detector = makeDetectorPath( "ldmx-det-v12" )


mySim.description = "Inclusive single 4 GeV electron upstream"
...
inputName="inclusive_1e_upstream_4GeV.root"
...
p.inputFiles= [ inputName ]
outputName=inputName.replace(".root", "_with-1e-overlay_recon.root")
